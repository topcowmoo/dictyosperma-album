// Import the jsonwebtoken library for JWT functionality
const jwt = require("jsonwebtoken");
// Import the GraphQLError class to handle errors
...
module.exports = {
  // Creating a new instance of GraphQLError with a custom message for authentication errors
  AuthenticationError: new GraphQLError("Authentication Error"),
  // Extensions to be added to the GraphQL error for indication unauthenticated requests
  extensions: {
    code: "UNAUTHENTICATED",
  },

  // Middleware function to token authentication
  authMiddleware: function ({ req }) {
    // Extracting token from request headers, body, or query paramaters
